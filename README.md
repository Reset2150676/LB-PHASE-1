...
local A_1 = 
    {
        [1] = getrenv()._G.Pass,
        [2] = "Chatted", 
        [3] = "How funny this need to going now.", 
...
Sound.Playing = true
Sound.Looped = true
Sound.SoundId = "rbxassetid://2593058535" 
Sound.Name = "e"
...
local music = Instance.new("Sound")
        ...
        music.Name = "RAGE"
        music.Volume = 3
        music.SoundId = "rbxassetid://582476855"
        music.Looped = true
        music:Play()
newRad1 = 0
spawn(function()
...
local A_1 =  {
          ...
          [5] = CFrame.new(0,0,0)*CFrame.fromEulerAnglesXYZ(math.rad(-newRad1), math.rad(-newRad1 + 180),math.rad(-newRad1))
      }
      local Event = game:GetService("ReplicatedStorage").Remotes.Events
      Event:FireServer(A_1)
end
until
jajajaja_ligma_balls == true
end)
wait(1)
print("nDebug7")
spawn(function()
...
local A_1 =  {
          ...
          [3] = test, 
          [4] = Color3.fromHSV(hue, 1, 1), 
          [5] = CFrame.new(0,0,0)*CFrame.fromEulerAnglesXYZ(math.rad(-newRad1), math.rad(newRad1),math.rad(-newRad1))
      }
      local Event = game:GetService("ReplicatedStorage").Remotes.Events
      Event:FireServer(A_1)
end
